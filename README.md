...
- **상세 페이지**: POI별 ISR 페이지 (SEO 최적화, JSON-LD, hreflang, Twitter Card)
- **방문 정보**: 상세 페이지에서 이용시간, 휴무일, 주차, 시설 안내 표시
- **상세 정보 분기**: contentTypeId별 전용 UI (축제 행사정보, 숙박 객실카드, 음식점 메뉴, 쇼핑 품목, 레저 예약, 여행코스 단계)
- **이미지 갤러리**: 상세 페이지에서 가로 스크롤 이미지 갤러리 표시
- **반려동물 동반 정보**: 동반 유형, 필요 자재, 캠핑 정보, 구비 시설, 렌탈 품목 등 9개 필드 표시
